...
public class MiniGameDice : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!isRolling && MiniGameManager.instance.currentTime > 0)
        {
    ...
    private IEnumerator RollDice()
    {
        ...
        MiniGameManager.instance.MovePlayer(finalNumber);
